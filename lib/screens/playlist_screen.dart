...
class _PlaylistScreenState extends State<PlaylistScreen> {
  ...
  Future<void> _load() async {
    ...
    final songs = await context.read<LibraryProvider>().getPlaylistSongs(api, widget.playlist.id);
          ...
          : _songs == null || _songs!.isEmpty
              ? const Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.playlist_play_rounded, size: 64, color: AppTheme.subtle),
                      SizedBox(height: 12),
                      Text('No songs in playlist', style: TextStyle(color: AppTheme.subtle)),
                    ],
                  ),
                )
              : Column(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return SongTile(
                            ...
                            onRemoveDownload:
                                isDownloaded ? () => downloads.remove(song.id) : null,
                          );
                        },
                      ),
                    ),
